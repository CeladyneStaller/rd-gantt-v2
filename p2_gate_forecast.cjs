...
setTimeout(()=>{ const d=w.document, s=d.createElement('script');
  s.textContent=`(function(){ try{ var o={}; var T=todayDay();
    ...
    exec.stageGates=[
      ...
      {id:'h2',objectiveId:'O2',setId:'S2',name:'Cost model',plannedDate:T+40} ];                  // accel possible
    exec.stageGateSets=[ {id:'S1',objectiveId:'O1',name:'Qual',chained:true}, {id:'S2',objectiveId:'O2',name:'Cost',chained:true} ];
  ...
  setTimeout(()=>{ const raw=d.body.getAttribute('data-out')||'{}';
    ...
    ok(/\+30d slip/.test(o.stripO1), 'objective Schedule card shows +30d slip');
